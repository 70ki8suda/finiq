...
def generate_metadata(category: str, text: str, file_path: Path, llm) -> ArticleMetadata:
   ...
   あなたは、SEOに精通したコンテンツストラテジストです。
    ...
    5. 西暦の年数をタイトルに含む場合は正しい年数を表記するように注意してください (2024年についての情報であれば2024年、2025年についての情報であれば2025年と表記するように注意してください。誤った表記はメディアの信頼性を損ねます。dateの西暦とこのタイトルに表記される年数が違うようなことは基本的にほとんどないはずです。注意してください。)
